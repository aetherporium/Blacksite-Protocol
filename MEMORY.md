...
- Independent critique pass accepted and implemented: the turbine bay gained wet puddle zones, elevated grating, utility cabinets, cable trays, wall bracing, risers, catwalk signal detail, and additional work-light depth. Enemies gained chest armor, shoulder silhouette, comms hardware, and rifle detail; the player rifle gained an optic lens, barrel shroud, selector, and heat strip. The finalized objective marker uses the split-chevron identity rather than a generic diamond.
